...
const CompliancePortal: React.FC = () => {
  ...
  const complianceRender = () => {
    switch (step) {
      case 1:
        return (
          <ContentBox maxWidth="480px" gap="32px">
            <Typography
              fontSize="32px"
              lineHeight="41px"
              fontWeight="700"
      ...
      case 2:
        return (
          <ContentBox maxWidth="480px" gap="32px" paddingBottom="64px">
          ...
          >
            ...
            >
              <Stack
                ...
                alignItems="center"
              >
                <Box bgcolor="#576E63" borderRadius="100px" padding="6px 8px">
                  <Stack direction="row" gap="8px">
                    <Image
                      src={Ethereum.src}
                      width={18}
            ...
            {!isVerified && (
              <Stack alignItems={"center"} borderRadius="4px">
